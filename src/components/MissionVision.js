...
const MissionVision = () => {
  return (
    ...
    <div className='max-w-[1300px] m-auto py-10 grid lg:grid-cols-2 gap-4  text-black'>
        {/* left Side  */}
      <div className='grid rounded-md md:pr-2 '>
           <img className='object-cover w-full h-full rounded shadow-lg px-10' src={MissionVisionimg} alt='About-company'></img>
      </div>
        {/* Right Side  */}
        <div className='flex flex-col h-full justify-center pl-2 px-10'>
            <div className='mb-3'>
               ...
               <p className='text-x py-2 md:text-justify text-left'>Our mission is to leverage our unparalleled expertise for creating global investment opportunities. 
            ...
            <div className='mb-3'>
               ...
               <p className='text-x py-2 md:text-justify text-left'>To be the premier global investment platform - delivering exceptional and sustainable returns, 
