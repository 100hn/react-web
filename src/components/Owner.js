...
const Owner = () => {
    ...
    <div className='max-w-[1300px] m-auto py-16 px-8 grid lg:grid-cols-2 gap-6 '>
        ...
        <div className='flex flex-col h-full justify-center '>
            ...
            <p className='text-sm py-1 text-justify'>Meet Alok Sanghi, the pioneering leader behind Resolute Group. Alok is a Finance and Economics graduate from Indiana University, Bloomington, USA. Alok steered Sanghi Industries Ltd. with a strong commitment to sustainability. Before joining the company, he has worked with Merrill Lynch and Regency Securities. Known for his innovative approach, Alok has driven operational excellence and efficiency within every organization he has been part of. </p>
            <p className='text-sm py-1 text-justify'>Alok likes to focus on people, entrepreneurship, and management quality. He would like to add value to the lives of people in the world through his business and to contribute to society through sustainability and skill development initiatives.</p>
            <p className='text-sm py-1 text-justify'>As a director with key roles in various companies, including Resolute, Samruddhi, Sanghi Infrastructure Limited, and Sanghi Energy Limited, Alok embodies a forward-thinking and holistic approach to business. His leadership ensures long-term success across all ventures. </p>
            <h3 className='text-2xl md:text-3xl font-bold uppercase text-center pt-6 pb-2'>Alok Sanghi</h3>
            <p className='text-sm py-1 text-center'>Director, Resolute Group</p>
            </div>
        </div>
        {/* Right Side  */}
        <div className='grid h-full rounded-md'>
            <img className='object-cover w-full shadow-lg  rounded-md' src={onwerimg} alt='Owner'></img>
        </div>
    </div>
    </div>
    )
